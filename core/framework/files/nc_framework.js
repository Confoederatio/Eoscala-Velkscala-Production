//Initialise functions
{
   ...
   */
  global.convertNCToASC = async function (arg0_input_file_path, arg1_output_file_path, arg2_options) {
    ...
    if (!options.longtude_key) options.longitude_key = "longitude";
    ...
    var cellsize = reader.getDataVariable(options.longitude_key)[1] - reader.getDataVariable(options.longitude_key)[0];
    var ncols = reader.dimensions.find((dimension) => dimension.name === options.longitude_key).size;
    var nodata = -9999;
    var nrows = reader.dimensions.find((dimension) => dimension.name === options.latitude_key).size;
    var xllcorner = reader.getDataVariable(options.longitude_key)[0];
    var yllcorner = reader.getDataVariable(options.latitude_key)[nrows - 1];
  ...
  global.getNCVariables = function (arg0_input_file_path) {
    //Convert from parameters
    var input_file_path = arg0_input_file_path;
  ...
  global.processSEDAC = async function (arg0_input_file_path, arg1_output_folder, arg2_variable_key) {
    //Convert from parameters
    var input_file_path = arg0_input_file_path;
